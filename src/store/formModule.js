...
const equipment = [
  { id: 1, name: 'Камера Sony A7III', price: 2000, category: 'Камеры', image: '/images/camera.png', inStock: 3, description: {
    characteristics: ['Оптический зум', 'Цифровая зеркальная камера', 'APS-C CMOS', '24.2 МП', '10 кадров/с', 'ISO 100-25600'],
  ...
  { id: 2, name: 'Штатив Manfrotto', price: 500, category: 'Штативы', image: '/images/tripod.png', inStock: 3, description: {
    characteristics: ['высота до 180 см', 'гладкий алюминий с гравировкой', 'размеры: 40x40x180 см', 'вес: 1.5 кг'],
  ...
  { id: 3, name: 'Педаль Pearl 100P', price: 100, category: 'Ударные', image: '/images/drum-pedal.png', inStock: 3, description: {
    characteristics: ['Прочная конструкция', 'Плавный ход', 'Регулируемая пружина'],
  ...
  { id: 4, name: 'Педаль Iron Cobra 200', price: 100, category: 'Ударные', image: '/images/drum-pedal.png', inStock: 3, description: {
    characteristics: ['Высокая точность', 'Долговечность', 'Регулируемый угол наклона'],
  ...
  { id: 5, name: 'Педаль Yamaha', price: 100, category: 'Ударные', image: '/images/drum-pedal.png', inStock: 3, description: {
  ...
  { id: 6, name: 'Тарелка Crash', price: 200, category: 'Ударные', image: '/images/crash-cymbal.png', inStock: 3, description: {
    characteristics: ['Яркий звук', 'Долговечность', 'Высокое качество материала'],
  ...
  { id: 7, name: 'Тарелка Ride', price: 100, category: 'Ударные', image: '/images/ride-cymbal.png', inStock: 3, description: {
    characteristics: ['Чистый звук', 'Универсальность', 'Прочная конструкция'],
  ...
  { id: 8, name: 'Тарелка Hi-hat', price: 100, category: 'Ударные', image: '/images/hi-hat-cymbal.png', inStock: 3, description: {
  ...
  { id: 9, name: 'Малый барабан Yamaha', price: 100, category: 'Ударные', image: '/images/small-drum.png', inStock: 3, description: {
    characteristics: ['Качественный материал', 'Яркий звук', 'Простота настройки'],
  ...
  { id: 10, name: 'Электронная гитара Kramer Striker', price: 100, category: 'Электрогитары', image: '/images/electric-guitar.png', inStock: 1, description: {
    characteristics: ['Стильный дизайн', 'Высокое качество звука', 'Удобный гриф'],
...
const services = [
  { id: 1, name: 'Отпариватель', price: 200, category: 'Категория 1', image: '/images/steamer.png', inStock: 3, description: {
    characteristics: ['Компактный размер', 'Быстрый нагрев', 'Эффективное удаление складок'],
  ...
  { id: 2, name: 'Гримерка', price: 200, category: 'Категория 1', image: '/images/dressing-room.png', inStock: 3, description: {
    characteristics: ['Комфортное пространство', 'Зеркало с подсветкой', 'Удобное расположение'],
  ...
  { id: 3, name: 'Запись гитары', price: 100, category: 'Категория 2', image: '/images/guitar-recording.png', inStock: 1, description: {
    characteristics: ['Профессиональное оборудование', 'Высокое качество звука', 'Индивидуальный подход'],
  ...
  { id: 4, name: 'Запись вокала', price: 150, category: 'Категория 2', image: '/images/vocal-recording.png', inStock: 2, description: {
    characteristics: ['Студийное оборудование', 'Опытный звукорежиссер', 'Высокое качество записи'],
  ...
  { id: 5, name: 'Аренда студии', price: 500, category: 'Категория 2', image: '/images/studio-rental.png', inStock: 1, description: {
    characteristics: ['Просторное помещение', 'Профессиональное оборудование', 'Комфортная атмосфера'],
  ...
  { id: 6, name: 'Микрофон', price: 150, category: 'Категория 1', image: '/images/microphone.png', inStock: 2, description: {
    characteristics: ['Высокое качество звука', 'Универсальность', 'Простота использования'],
  ...
  { id: 7, name: 'Светодиодная лампа', price: 100, category: 'Категория 1', image: '/images/led-lamp.png', inStock: 5, description: {
    characteristics: ['Энергоэффективность', 'Долгий срок службы', 'Яркий свет'],
  ...
  { id: 8, name: 'Зеркало с подсветкой', price: 250, category: 'Категория 1', image: '/images/mirror.png', inStock: 1, description: {
    characteristics: ['Регулируемая подсветка', 'Большой размер', 'Стильный дизайн'],
  ...
  { id: 9, name: 'Запись барабанов', price: 300, category: 'Категория 2', image: '/images/drum-recording.png', inStock: 1, description: {
    characteristics: ['Профессиональное оборудование', 'Высокое качество звука', 'Индивидуальный подход'],
  ...
  { id: 10, name: 'Аренда звукового оборудования', price: 400, category: 'Категория 2', image: '/images/sound-equipment.png', inStock: 2, description: {
    characteristics: ['Широкий выбор оборудования', 'Высокое качество', 'Профессиональная поддержка'],

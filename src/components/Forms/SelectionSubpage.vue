	...
	<div>
		...
		<div v-else class="mb-4">
			<div class="d-flex justify-space-between align-center mb-2">
				...
				<v-btn variant="outlined" size="small" @click="isOpen = true">
					Добавить {{ addButtonText }}
				</v-btn>
			</div>
      ...
      :order='2'
		...
		>
			...
			<v-card  flat class="pa-4 d-flex ga-2">
				<v-btn block class='action-button' variant="text" @click="isOpen = false">Назад</v-btn>
				<v-btn block class='action-button' color="black" @click="addSelected">Добавить</v-btn>
			</v-card>
		</v-navigation-drawer>
